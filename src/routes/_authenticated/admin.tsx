...
import { Users, FileText, MessageSquare, LayoutDashboard, ShieldAlert, Megaphone, HardHat, GraduationCap, Store, Scale, Droplet, HeartPulse, Handshake, Plane, FileSignature, Landmark, Car, Package, Wifi, Heart, Menu } from "lucide-react";
...
const TABS: ReadonlyArray<{ to: string; label: string; icon: typeof Users; exact?: boolean }> = [
  ...
  { to: "/admin/legal", label: "আইনি সহায়তা", icon: Scale },
  { to: "/admin/blood-donors", label: "রক্তদাতা", icon: Droplet },
  { to: "/admin/blood-requests", label: "রক্তের অনুরোধ", icon: HeartPulse },
