...
import { UPAZILAS, DISTRICTS, type CategoryRow } from "@/lib/workers-shared";
...
function WorkerRegister() {
  ...
  const [form, setForm] = useState({
    ...
    skills: "", experience_years: "", district: DISTRICTS[0] as string,
    ...
    return (
      <div className="mx-auto max-w-lg px-4 py-16 text-center">
        ...
        <div className="mt-6 flex justify-center gap-2">
          <Button asChild variant="outline"><Link to="/workers">ডিরেক্টরিতে ফিরে যান</Link></Button>
          <Button onClick={() => { setDone(false); setForm({ ...form, full_name: "", phone: "", whatsapp: "", skills: "", area: "", description: "" }); }}>আরও নিবন্ধন</Button>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-6 sm:px-6">
      ...
      <h1 className="text-2xl font-bold sm:text-3xl">👷 কাজের লোক নিবন্ধন</h1>
      ...
      <Card className="mt-5">
        <CardContent className="p-5">
          <form onSubmit={onSubmit} className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="sm:col-span-2">
              <Label>দক্ষতা</Label>
              <Textarea value={form.skills} onChange={(e) => update("skills", e.target.value)} placeholder="যেমন: হাউস ওয়্যারিং, সোলার সেটআপ" rows={2} />
            </div>
